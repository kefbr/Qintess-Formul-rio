											...
											.click(
													function(e) {
														...
														if (x < max_fields) {
															...
															$(wrapper)
																	.append(
																			'<div><div class="input-group mb-2" style="margin: 3px 3px 0px 0px"><form:input class="form-control" path="certificacao" /><span class="input-group-btn"><button class="btn btn-danger" type="button" id="delete">Deletar</button></span></div></div>');
														} else {
